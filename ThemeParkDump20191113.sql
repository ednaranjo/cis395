CREATE DATABASE  IF NOT EXISTS `themepark` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `themepark`;
...
INSERT INTO `attraction` VALUES (10034,'ThunderCoaster',14,34,'FR1001'),(10056,'SpinningTeacups',4,62,'FR1001'),(10067,'FlightToStars',11,24,'FR1001'),(10078,'Ant-Trap',23,30,'FR1001'),(10098,NULL,3,120,'FR1001'),(20056,'3D-Lego_Show',3,200,'UK3452'),(30011,'BlackHole2',12,34,'UK3452'),(30012,'Pirates',10,42,'UK3452'),(30044,'UnderSeaWord',4,80,'UK3452'),(98764,'GoldRush',5,80,'ZA1342');
/*!40000 ALTER TABLE `attraction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `emp_copy`
--
...
CREATE TABLE `emp_copy` (
  ...
  PRIMARY KEY (`EMP_NUM`),
  KEY `PARK_CODE` (`PARK_CODE`),
  CONSTRAINT `FK_EMP_CPY_PARK` FOREIGN KEY (`PARK_CODE`) REFERENCES `themepark` (`PARK_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `emp_copy`
--

LOCK TABLES `emp_copy` WRITE;
/*!40000 ALTER TABLE `emp_copy` DISABLE KEYS */;
INSERT INTO `emp_copy` VALUES (100,'Ms','Calderdale','Emma','1972-06-15','1992-03-15','0181','324-9134','FR1001'),(101,'Ms','Ricardo','Marshel','1978-03-19','1996-04-25','0181','324-4472','UK3452'),(102,'Mr','Arshad','Arif','1969-11-14','1990-12-20','7253','675-8993','FR1001'),(103,'Ms','Roberts','Anne','1974-10-16','1994-08-16','0181','898-3456','UK3452'),(104,'Mr','Denver','Enrica','1980-11-08','2001-10-20','7253','504-4434','ZA1342'),(105,'Ms','Namowa','Mirrelle','1990-03-14','2006-11-08','0181','890-3243','FR1001'),(106,'Mrs','Smith','Gemma','1968-02-12','1989-01-05','0181','324-7845','ZA1342');
/*!40000 ALTER TABLE `emp_copy` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `employee` VALUES (100,'Ms','Calderdale','Emma','1972-06-15','1992-03-15','0181','324-9134','FR1001'),(101,'Ms','Denver','Marshel','1978-03-19','1996-04-25','0181','324-4472','UK3452'),(102,'Mr','Arshad','Arif','1969-11-14','1990-12-20','7253','675-8993','FR1001'),(103,'Ms','Roberts','Anne','1974-10-16','1994-08-16','0181','898-3456','UK3452'),(104,'Mr','Denver','Emma','1980-11-08','2001-10-20','7253','504-4434','ZA1342'),(105,'Ms','Denver','Mirrelle','1990-03-14','2006-11-08','0181','890-3243','FR1001'),(106,'Mrs','Smith','Emma','1968-02-12','1989-01-05','0181','324-7845','ZA1342');
...
INSERT INTO `themepark` VALUES ('FR1001','FairyLand','PARIS','FR'),('NL1202','Efling','NOORD','NL'),('SP4533','AdventurePort','BARCELONA','SP'),('UK2622','MiniLand','WINDSOR','UK'),('UK3452','PleasureLand','STOKE','UK'),('ZA1342','GoldTown','JOHANNESBURG','ZA');
...
-- Dump completed on 2019-11-13 19:16:33
